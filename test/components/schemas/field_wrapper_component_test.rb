...
class FieldWrapperComponentTest < ViewComponent::TestCase
  test "renders label with required mark and content" do
    ...
    render_inline Jquard::Schemas::FieldWrapperComponent.new(field: field, record: Post.new) { "<input/>".html_safe }
  ...
  test "renders the first validation error" do
    ...
    render_inline Jquard::Schemas::FieldWrapperComponent.new(field: field, record: record) { "x" }
  ...
  test "renders helper text" do
    ...
    render_inline Jquard::Schemas::FieldWrapperComponent.new(field: field, record: Post.new) { "x" }
